            ...
            L.DomEvent.addListener L.DomUtil.get("print"), 'click', (e) ->
                ...
                html2canvas document.getElementById("map"),
                    ...
                    onrendered: (canvas) ->
                        ...
                        doc.line(gon.sparkline_x_left+9, gon.transportation_z_point_y+gon.section_header_lead+gon.sparkline_lead-4, gon.sparkline_x_left+9, gon.transportation_z_point_y+gon.section_header_lead+gon.sparkline_lead-28)
                        ...
                        doc.line(gon.sparkline_x_left+16, gon.transportation_z_point_y+gon.section_header_lead+gon.sparkline_lead-4, gon.sparkline_x_left+16, gon.transportation_z_point_y+gon.section_header_lead+gon.sparkline_lead-21)
                        doc.text("median", gon.sparkline_x_left+17, gon.transportation_z_point_y+gon.section_header_lead+gon.sparkline_lead-22)
                        doc.line(gon.sparkline_x_left+25, gon.transportation_z_point_y+gon.section_header_lead+gon.sparkline_lead-4, gon.sparkline_x_left+25, gon.transportation_z_point_y+gon.section_header_lead+gon.sparkline_lead-10)
                        doc.text("75th quantile", gon.sparkline_x_left+24, gon.transportation_z_point_y+gon.section_header_lead+gon.sparkline_lead-11)
